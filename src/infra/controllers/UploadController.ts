  ...
  public constructor(
    ...
    this.httpServer.register(
      ...
      async (params, _body, _query, req) => {
        ...
        return this.uploadTrackAudioUseCase.execute(params.id, file.buffer, type.mime)
      },
    ...
    this.httpServer.register(
      ...
      async (params, _body, _query, req) => {
        ...
        return this.uploadAlbumCoverUseCase.execute(params.id, file.buffer, type.mime)
      },
      [this.authMiddleware.handle(), UPLOAD_RATE_LIMIT, this.upload.single('file')],
    )
    ...
    this.httpServer.register(
      ...
      async (params, _body, _query, req) => {
        ...
        return this.uploadArtistProfileImageUseCase.execute(params.id, file.buffer, type.mime)
      },
      [this.authMiddleware.handle(), UPLOAD_RATE_LIMIT, this.upload.single('file')],
    )
    ...
    this.httpServer.register(
      ...
      async (params, _body, _query, req) => {
        ...
        return this.uploadPlaylistCoverUseCase.execute(params.id, file.buffer, type.mime)
      },
      [this.authMiddleware.handle(), UPLOAD_RATE_LIMIT, this.upload.single('file')],
    )
  }
