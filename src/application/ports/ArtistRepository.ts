...
export interface ArtistRepository {
	 ...
	 */
	delete(artistId: string): Promise<Artist | null>
	 ...
	 * @param artistId - The unique identifier of the Artist to update.
	 * @param data - The partial data to update the Artist with.
	 * @returns A promise that resolves when the update is complete.
	 */
	update(artistId: string, data: Partial<Artist>): Promise<Artist | null>

	/**
	 * Searches for Artists based on a query string, with pagination support.
	 * @param page The page number to retrieve (1-indexed).
	 * @param limit The maximum number of Artists to return per page.
